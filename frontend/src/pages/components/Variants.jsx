            ...
            <div className="variants" key={index}>
              ...
              <div className="colorName-quantity-images">
                ...
                <div className="quantity">
                  <p>Stock Quantity</p>
                  <Field className="stock-quantity-input" name={`variants[${index}].stockQuantity`} type="number" />
                  ...
                  <button
                    ...
                    onClick={() =>
                      setFieldValue(
                        ...
                        [...variant.availableSizes, { mensSize: "", womensSize: "" }]
                      )
                    }
                  >
                ...
                {variant.availableSizes.map((size, sizeIndex) => (
                  <div className="men-women-size" key={sizeIndex}>
                    <div className="men-size">
                      <p>Men's Size</p>
                      <Field className="mens-size-input" name={`variants[${index}].availableSizes[${sizeIndex}].mensSize`} type="number" />
                    </div>
                    <div className="women-size">
                      <p>Women's Size</p>
                      <Field className="womens-size-input" name={`variants[${index}].availableSizes[${sizeIndex}].womensSize`} type="number" />
                    </div>
                    <button
                      type="button"
                      onClick={() =>
                        setFieldValue(
                          `variants[${index}].availableSizes`,
                          variant.availableSizes.filter((size, i) => i !== sizeIndex)
                        )
                      }
                    >
